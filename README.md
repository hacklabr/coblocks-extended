# CoBlocks Extended: An extended version of CoBlocks
...
1. Clone the GitHub repository: `https://github.com/hacklabr/coblocks-extended.git`
...
Please read the [guidelines for contributing](https://github.com/hacklabr/coblocks-extended/blob/master/.github/CONTRIBUTING.md) to CoBlocks. Anyone is welcome to contribute. If you find a 🐞 or an issue, [create an issue](https://github.com/hacklabr/coblocks-extended/issues/new). Here are ways to contribute:

1. Raise an [issue](https://github.com/hacklabr/coblocks-extended/issues/new)
